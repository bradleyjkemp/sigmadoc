...
date: Mon, 3 Apr 2017 09:12:58 -0400
...
## Raw rule ([edit](https://github.com/SigmaHQ/sigma/edit/master/rules/windows/builtin/security/win_alert_enable_weak_encryption.yml))
```yaml
title: Weak Encryption Enabled and Kerberoast
